...
public:
    ...
    int Simulate(model::Unit& unit, model::UnitOrder& order, std::vector<model::Projectile>& bullets, const std::vector<model::Unit>& enemies, const model::Zone& zone, int ticks) const;

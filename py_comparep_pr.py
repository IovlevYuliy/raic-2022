...
players=[]
players.append(Player(r'/build/ai_cup_22', 'P_1'))
...
def runProc(i):
    ...
    server=subprocess.Popen('/home/yuliy/projects/raic-2022/app-linux/aicup22 --config {conf_name} --save-results {results_name} --batch-mode' , shell=True, stdout=subprocess.PIPE, stderr=subprocess.STDOUT)
